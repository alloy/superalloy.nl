...
_I just love how easy it is to write "small" tools with Ruby and Cocoa that do seemingly "big" things. For another example see "the next blog post":/blog/2009/04/13/js-test-san.html._
